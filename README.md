...
## Installation
```
npm install @chesszebra/zx-tabs --save
```
...
[ico-travis]: https://img.shields.io/travis/chesszebra/zx-tabs/master.svg?style=flat-square

[link-travis]: https://travis-ci.org/chesszebra/zx-tabs
